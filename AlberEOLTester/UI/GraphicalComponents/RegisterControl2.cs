...
{
    public partial class RegisterControl2 : UserControl
    {
        ...
        public bool Bit0Status
        {
            ...
            {
                bit0Status = value;
                Bit0Label.BackColor = value ? Color.IndianRed : Color.LimeGreen;
            }
        }
        ...
        public bool Bit1Status
        {
            ...
            {
                bit1Status = value;
                Bit1Label.BackColor = value ? Color.IndianRed : Color.LimeGreen;
            }
        }
        ...
        public bool Bit2Status
        {
            ...
            {
                bit2Status = value;
                Bit2Label.BackColor = value ? Color.IndianRed : Color.LimeGreen;
            }
        }
        ...
        public bool Bit3Status
        {
            ...
            {
                bit3Status = value;
                Bit3Label.BackColor = value ? Color.IndianRed : Color.LimeGreen;
            }
        }
        ...
        public bool Bit4Status
        {
            ...
            {
                bit4Status = value;
                Bit4Label.BackColor = value ? Color.IndianRed : Color.LimeGreen;
            }
        }
        ...
        public bool Bit5Status
        {
            ...
            {
                bit5Status = value;
                Bit5Label.BackColor = value ? Color.IndianRed : Color.LimeGreen;
            }
        }
        ...
        public bool Bit6Status
        {
            ...
            {
                bit6Status = value;
                Bit6Label.BackColor = value ? Color.IndianRed : Color.LimeGreen;
            }
        }
        ...
        public bool Bit7Status
        {
            ...
            {
                bit7Status = value;
                Bit7Label.BackColor = value ? Color.IndianRed : Color.LimeGreen;
            }
        }

        public RegisterControl2()
        {
            InitializeComponent();
        }
    }
